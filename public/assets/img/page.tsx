            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                <MotionSection key={i} direction="up" delay={i * 0.2}>
                  <div className={`bg-gradient-to-r from-pink-500/10 to-blue-500/10 border border-pink-500/30 rounded-2xl p-6 shadow-xl border border-pink-500/30 h-full`}>
    ...
    <MotionSection direction="up">
      ...
      <div className="grid md:grid-cols-3 gap-8 mb-12">
        {[
          ...
          { title: 'Mots', icon: Volume2, desc: 'Cliquez sur chaque Mots pour écouter sa prononciation claire et précise.' },
          { title: 'Phrases', icon: Volume2, desc: 'Cliquez sur chaque Phrases pour écouter sa prononciation claire et précise.' },
        ].map(({ title, icon: Icon, desc }, i) => (
          <div key={i} className="bg-gradient-to-r from-pink-500/10 to-blue-500/10 border border-pink-500/30 rounded-2xl p-8 border border-pink-500/30 hover:border-pink-500/60 transition-all transform hover:-translate-y-2">
        ...
        <section className="py-20 bg-gradient-to-r from-black-500/10 to-black-500/10 border-y border-pink-500/30">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {[
                { img: GalleryImage, title: 'Interface intuitive' },
                { img: GalleryImage, title: 'Apprentissage progressif' },
                { img: GalleryImage, title: 'Exercices interactifs' },
                { img: GalleryImage, title: 'Suivi de progression' },
              ].map((item, i) => (
