        ...
        <div className="main-container">
          <div className="section-container py-12">
            <header className="text-center mb-12">
              ...
              <div className="inline-flex items-center gap-4 bg-sky-50 rounded-xl px-6 py-3">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-8 lg:p-12">
              <div className="prose prose-slate prose-lg max-w-none
                ...
                prose-a:text-sky-500 prose-a:no-underline hover:prose-a:text-sky-600
              ">
                {children}
              </div>
            </div>
            ...
            <div className="mt-6 flex flex-wrap items-center justify-center gap-4 text-sm">
              <Link href="/legal" className="text-gray-600 hover:text-sky-500 transition-colors font-medium">
                Mentions legales
              </Link>
              <span className="text-gray-300">|</span>
              <Link href="/cgv" className="text-gray-600 hover:text-sky-500 transition-colors font-medium">
                CGV
              </Link>
              <span className="text-gray-300">|</span>
              <Link href="/" className="text-gray-600 hover:text-sky-500 transition-colors font-medium">
                Retour a l'accueil
              </Link>
            </div>
          </div>
